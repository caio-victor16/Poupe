...
O projeto foi modelado utilizando Diagramas de Classes UML, representando o domínio do sistema por meio das principais entidades, seus atributos e relacionamentos, seguindo os conceitos de associação, agregação e herança.
